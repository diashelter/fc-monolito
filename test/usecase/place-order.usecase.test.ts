...
import PlaceOrderUseCase from "../../src/modules/checkout/usecase/place-order/place-order.usecase";
import { PlaceOrderInputDto } from "../../src/modules/checkout/usecase/place-order/place-order.usecase.dto";

const mockDate = new Date(2000, 1, 1);
describe("Place Order UseCase unit test", () => {
    describe("validat eProducts method", () => {
        ...
        describe("place an order", () => {
            ...
            it("should be approved", async () => {
                ...
                expect(mockInvoiceFacade.create).toHaveBeenCalledWith({
                    ...
                    items: [
                        {
                            id: products["1"].getId().getId(),
                            name: products["1"].getName(),
                            price: products["1"].getSalesPrice(),
                        },
                        {
                            id: products["2"].getId().getId(),
                            name: products["2"].getName(),
                            price: products["2"].getSalesPrice(),
                        },
                    ],
                });
            });
